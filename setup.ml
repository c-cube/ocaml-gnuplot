...
(* OASIS_START *)
(* DO NOT EDIT (digest: 55846fd86deb5c4cc3049ccbd6967057) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              "This library is a clone of FSharp.GnuPlot from Tomas Petricek.";
          categories = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\143\243hz\006V\021\220GX\155\245d1\226N";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
