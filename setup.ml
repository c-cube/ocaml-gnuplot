...
(* OASIS_START *)
(* DO NOT EDIT (digest: b61988cf5c7726402e3136fc92c5ca9d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Gnuplot-OCaml is an OCaml clone of FSharp.GnuPlot from Tomas Petricek."
              ];
          categories = [];
          ...
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("$rm", ["test1.png"])))]
            };
          files_ab = [];
          sections =
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ex1.ml"});
               Executable
                 ({
                     cs_name = "ex2";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ex2.ml"});
               Executable
                 ({
                     cs_name = "ex3";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ex3.ml"});
               Executable
                 ({
                     cs_name = "ex4";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ex4.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\\\167\167\151\221\182<\130\218\2460\151\153\001s\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
