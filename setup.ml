...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1dda7fc506417f396c7635c57432ae55) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "114.35.00"));
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "save_plot.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\192\1644Y>\2360\189?G\175\131\249~\237\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
